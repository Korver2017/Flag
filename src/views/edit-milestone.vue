<template>
  <div>
    <div id="wrap" class="my-3">
      ...
      <h1>Edit Milestone Component!</h1>
      ...
      <div class="text-right">
        ...
        <button class="mr-3 btn btn-outline-primary" @click="cancelEdit">取消</button>
        <button class="btn btn-success" @click="updateMile">更新里程碑</button>
  ...
  export default {
    ...
    methods: {
      ...
      getMileData () {
        ...
        query.get ($vmc.mileId)
          .then (resp => {
            $vmc.mileTitle = resp.get ('title');
            $vmc.mileDesc = resp.get ('mileDesc');
            $vmc.date = resp.get ('dueDate');
          })
